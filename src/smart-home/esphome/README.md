...
- [`devices/presence-entrance-hall.yaml`](devices/presence-entrance-hall.yaml) — ESP32-C6 SuperMini + HLK-LD2410C mmWave presence sensor, entrance hall. Flashed and on the network.
